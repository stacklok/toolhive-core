...
import (
	...
	plugins "github.com/stacklok/toolhive-core/oci/plugins"
...
func (m *MockPluginPackager) Package(ctx context.Context, pluginDir string, opts plugins.PackageOptions) (*plugins.PackageResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Package", ctx, pluginDir, opts)
	ret0, _ := ret[0].(*plugins.PackageResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPluginPackagerMockRecorder) Package(ctx, pluginDir, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Package", reflect.TypeOf((*MockPluginPackager)(nil).Package), ctx, pluginDir, opts)
}
